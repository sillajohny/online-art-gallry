...
<tr>
  ...
  <tr>
    ...
    <td valign="top"><input type="text" name="lname" value='<?php echo $lname ?> '></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top"><input type="text" name="country" value='<?php echo $country1 ?> '></td>
  </tr>
  <tr>
  ...
  <button type="submit" name="revm"  id="revm" class="btn"><a href="edituser.php">Edit Profile</a></td></tr>
