...
<html lang="en">
	...
	<select name="country" name="country" id="country" onchange="getId(this.value);">
	 ...
	 <?php
            ...
            <div class="col-md-4">
                <input id="state" name="state" type="text" placeholder="Enter country name" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="submit" name="signup" value="ADD STATE" id="signup" class="btn btn-success">
