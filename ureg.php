...
if(document.form1.address.value=="")
 ...
 <form name="form1" action="#" method="POST" id="form" enctype="multipart/form-data" onsubmit="return addUser()">
...
<?php
   ...
   <input type="file" name="photo" id="photo"></div>
	                      ...
	                      <div> <center> <button type="submit" name="submit" value="submit" class="btn">Register</button></center>
                           <p>Already have an account ? <a href="services.html">Login</a></p></div>
	                    </form>
