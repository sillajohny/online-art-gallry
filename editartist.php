			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">						
						<li class="active">
							<li class="active">
							<a href="editartist.php"><span aria-hidden="true" class="icon_house"></span><br>HOME</a>
						</li>
...
$us_id=$_SESSION['us_id'];
$sql2="UPDATE `uregistration` SET `fnam`='$fnam',`lnam`='$lnam',`gender`='$gender',`dob`='$dob',`mbno`='$mbno' ,`address`='$address',`edu`='$edu',`city`='$city',`email`='$email' WHERE `us_id`=$us_id";
...
<tr>
  ...
  <tr>
    ...
    <td width="165" valign="top"><input type="text" name="fnam" id="fnam" value="<?php echo $row['fnam'];?> "></td>
  </tr><br>
  <tr>
    <td valign="top"><div align="left">LastName:</div></td>
    <td valign="top"><input type="text" name="lnam"  id="lnam" value="<?php echo $row['lnam']; ?> "></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top"><input type="text" name="edu" value='<?php echo $row['edu']; ?> '></td>
  </tr>
  <tr>
