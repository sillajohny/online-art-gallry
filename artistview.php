			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">						
						...
						<li>
							<a href="index.php"><span aria-hidden="true" class="icon_tools"></span><br>LOGOUT</a>
							</li>
							<li>
...
<tr>
  ...
  <tr>
    ...
    <td valign="top"><input type="email" name="email" value='<?php echo $email ?> '></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top"><input type="text" name="mbno" value='<?php echo $mbno ?> '></td>
  </tr>
  <tr>
    <td valign="top"><div align="left">Address: </div></td>
    <td valign="top"><input type="text" name="address" value='<?php echo $address ?> '></td>
  </tr>
   <tr>
    <td valign="top"><div align="left">Education: </div></td>
    <td valign="top"><input type="text" name="edu" value='<?php echo $edu ?> '></td>
  </tr>
  <tr>
    <td valign="top"><div align="left">Country: </div></td>
    <td valign="top"><input type="text" name="country" id="country" value='<?php echo $country1 ?> '></td>
  </tr>
  <tr>
    <td valign="top"><div align="left">State: </div></td>
    <td valign="top"><input type="text" name="state" value='<?php echo $state1 ?> '></td>
  </tr>
  <tr>
    <td valign="top"><div align="left">City: </div></td>
    <td valign="top"><input type="text" name="city" value='<?php echo $city ?> '></td>
  </tr>
  ...
  <input type="button" name="revm"  id="revm" class="btn"><a href="editartist.php">Edit Profile</a></td></tr>
