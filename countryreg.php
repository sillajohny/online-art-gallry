...
<html lang="en">
    ...
    <body>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="countryname" name="countryname" type="text" placeholder="Enter country name" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="submit" name="signup" value="ADD COUNTRY" id="signup" class="btn btn-success">
                <button class="btn btn-primary" id="btn_Product_reg" onclick="location.href = 'admin.php';" style="float: right;">BACK</button>
            </div>
        </div>
